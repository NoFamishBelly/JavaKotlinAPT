...
import com.leon.lib_java_annotation.Route;
...
public class RouteProcessor extends AbstractProcessor {
    ...
    private Messager messager; //用于生成日志
...
//        messager.printMessage(Diagnostic.Kind.WARNING, "----------------------------------------------初始化测试用" );

        System.out.println("----------------------------------------------初始化测试用");
...
//        annotations.add("com.hongx.compiler.annotation.Route");
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        for (Element element : routeElements) {
            ...
            try {
                JavaFileObject source = mFiler.createSourceFile("com.leon.auto." + newClassName);
